...
function App() {
  return (
    <div className='w-full bg-gray-100 min-h-screen h-full'>
      <div className='max-w-screen-lg min-h-screen h-full mx-auto grid grid-cols-1 md:grid-cols-8 md:grid-rows-10 gap-8 md:gap-4 p-5' style={{ fontFamily: "DMSans-Medium" }}>
        <CreatePost />
        <SocialMediaAi />
        <ScheduleMedia />
        <ManageAccounts />
